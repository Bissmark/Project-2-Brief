...
**You will be working individually for this project.** You'll be designing and coding the app yourself. However, you will have access to up to 500 fifteen-minute one-on-one sessions with your instructors.
...
### Project Proposals - Friday 10th November:
...
2. **Demonstrate the Project:**
	...
	☐ Launch the deployed app by clicking the link in the README (if deployed).
...
☐ **A working full-stack app that meets or exceeds the above technical requirements, and built by you**.
